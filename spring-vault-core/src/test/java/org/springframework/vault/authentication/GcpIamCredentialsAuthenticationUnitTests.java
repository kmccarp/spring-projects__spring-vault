...
.addMethod(MethodDescriptor.newBuilder(ProtoLiteUtils.marshaller(SignJwtRequest.getDefaultInstance()),
							ProtoLiteUtils.marshaller(SignJwtResponse.getDefaultInstance())).setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.iam.credentials.v1.IAMCredentials/SignJwt").build(), asyncUnaryCall((request, responseObserver) -> {
